    ...
    return (
        <div className="container mx-auto">
            ...
            <div className=" grid grid-cols-12 my-10 gap-4">
                <div className="md:col-span-6 col-span-12 border border-indigo-200 bg-indigo-50 p-10">
                    <div>
                    ...
                    <Slider {...settings}>
                        {
                            products?.slice(products.length - 3, products.length).map(product => <div
                                key={product._id}
                                className=" border border-indigo-100 p-5 mx-1 rounded bg-indigo-50 h-96"
                            >
                                <div >
